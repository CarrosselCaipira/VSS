...
class Comportamento {
 public:
	 ...
	 */
 	 ...
 	 * @Author Rodrigo Bueno Dos Reis Rodrigues de Siqueira
 	 */
 	static void posicionaPosBola(Robo& r, posXY& b);
 	 ...
 	 * @Author Rodrigo Bueno Dos Reis Rodrigues de Siqueira
 	 */
 	static void posicionaPosBolaEmX(Robo& r, posXY& b);
 	 ...
 	 * @Author Rodrigo Bueno Dos Reis Rodrigues de Siqueira
 	 */
 	static void posicionaAbaixoBola(Robo& r,posXY& b);
 	 ...
 	 * @Author Rodrigo Bueno Dos Reis Rodrigues de Siqueira
 	 */
 	static void posicionaAcimaBola(Robo& r,posXY& b);
	...
	/**
	 * @fn Comportamento::posicionaPosBolaEmYPonderado(Robo& r, posXY b)
	 * @brief Define como objetivo do robo a posicao em y ponderada da bola (atualmente 1/3)
	 * @param Referencia para um robo
	 * @param referencia para a bola
