...
class Robo {
    ...
    public:
        ...
        velocidadeRobo getVelocidadeObj ();
        ...
        void setPosicaoObj (const float x, const float y);
				void setPosicaoObjX(const float x);
				void setPosicaoObjY (const float y);
        ...
        /*********************** FUNCAO ROTEIRO *************************/
        /* Define o identificador de roteiro do robo */
        void setRoteiro(enum ROTEIROS r);
				/****************************************************************/
