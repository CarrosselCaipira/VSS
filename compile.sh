...
clang++ -o MAIN MAIN.cpp atacanteBasico.o camera.o comportamento.o gestorArq.o goleiroBasico.o propositoGeralAtuadores.o propositoGeralCamera.o robo.o volanteBasico.o -std=c++11 `pkg-config --cflags --libs opencv`
